...
export default function Home() {
  return (
    <main>
      ...
      <h2 className="bg-[#001F5B] text-white lg:text-3xl md:text-xl sm:text-lg text-base font-medium font-serif italic leading-relaxed md:leading-relaxed text-center md:py-5 py-2.5">Our Instagram Feed</h2>
      <InstagramFeed />
    </main>
  );
}
