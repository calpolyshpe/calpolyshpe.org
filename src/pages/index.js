...
export default function Home() {
  return (
    <main>
      <HeroBanner imgUrl={'/HomeImgs/Mainpage_GroupPhoto.jpg'} title={'Society of Hispanic Professional Engineers'} subtitle={"California Polytechnic State University - San Luis Obispo"} />
