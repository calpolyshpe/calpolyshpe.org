  ...
  const SHPEvalues = [
    {
      pilar: "Familia",
      color: "text-[#0070C0]",
      body: "We take responsibility for our collective strength and passion by developing communities, building a diverse and inclusive membership, and challenging each other to be our best.",
    },
  ];
  return (
    <main>
      <HeroBanner
        imgUrl={"/2022 SHPE Banquet.jpg"}
        title={"Our History And Values"}
      />
      <WhatIs
        question={"Cal Poly SHPE History"}
        response={
      ...
      <div className="bg-[#001F5B] flex justify-center items-center md:pb-16 pb-10">
        <div className="lg:w-3/5 w-3/4 h-auto">
          <h1 className="text-white lg:text-3xl md:text-xl sm:text-lg text-base font-medium font-serif italic border-white border-t border-opacity-15 md:pt-14 pt-6">
            SHPE Values{" "}
          </h1>
          <h2 className="text-[#0070C0] flex justify-center lg:text-3xl md:text-xl sm:text-lg text-base font-medium font-sans md:mt-6 mt-3">
            Familia
          </h2>
          <h3 className="text-white flex justify-center lg:text-xl md:text-lg sm:text-md text-sm font-sans md:mt-6 mt-3">
            We take responsibility for our collective strength and passion by
            developing communities, building a diverse and inclusive membership,
            and challenging each other to be our best.
          </h3>
          <h2 className="text-[#D33A02] flex justify-center lg:text-3xl md:text-xl sm:text-lg text-base font-medium font-sans md:mt-6 mt-3">
            Service
          </h2>
          <h3 className="text-white flex justify-center lg:text-xl md:text-lg sm:text-md text-sm font-sans md:mt-6 mt-3">
            We act on a foundation of service. We commit to deliver the highest
            levels of quality, integrity, and ethical behavior. We act with
            empathy, patience, and understanding.
          </h3>
          <h2 className="text-[#72A9BE] flex justify-center lg:text-3xl md:text-xl sm:text-lg text-base font-medium font-sans md:mt-6 mt-3">
            Education
          </h2>
          <h3 className="text-white flex justify-center lg:text-xl md:text-lg sm:text-md text-sm font-sans md:mt-6 mt-3">
          ...
          <h2 className="text-[#FD652F] flex justify-center lg:text-3xl md:text-xl sm:text-lg text-base font-medium font-sans md:mt-6 mt-3">
            Resilience
          </h2>
          <h3 className="text-white flex justify-center lg:text-xl md:text-lg sm:text-md text-sm font-sans md:mt-6 mt-3">
            We embrace our diverse cultures and communities, which enable us to
            adapt, thrive, and persist with optimism.
          </h3>
        </div>
      </div>
    </main>
