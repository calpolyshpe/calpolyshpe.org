...
export default function SHPEJr() {
  return (
    <main>
      ...
      <WhatIs
        question={"What is SHPE Jr?"}
        response={
          "SHPE Jr as a program aims to provide more education for those in junior high and high school in regard to STEM related majors in college. Starting early is the key to successfully exploring a future in science, technology, engineering or mathematics. SHPE Jr aims to provide mentorship, campus trips, networking opportunities, college tips, activities like Noche de Ciencias, as well as other activities that can give insight to students about what STEM and STEM adjacent majors can offer!"
        }
      />
      <LightBlueWPic
      ...
      <LightBlueWPic
        ...
        content={
          "This past May 2022, our SHPE JR Committee hosted our annual Noche de Ciencias, with over 70 SHPE Jr participants joining and 30 SHPE Cal Poly SLO volunteers. The local family science night is designed to inspire Hispanic high school students to pursue STEM careers while also educating their parents on how to support their child’s goals."
        }
        imgURL={"/SHPEJrImgs/NDC flyer.png"}
      />
      <div className="bg-[#001F5B] flex flex-col justify-center items-center md:p-11 p-6"></div>
    </main>
  );
}
