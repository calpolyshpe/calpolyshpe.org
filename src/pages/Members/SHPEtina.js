...
export default function SHPEtina() {
    return (
        <main>
            <HeroBanner title={"SHPEtinas"} imgUrl={"/SHPEtinaImgs/SHPEtinaOfficers.jpg"}/>
            ...
            <LightBlueWPic content={"While women make up 24% of the STEM field, only 3% are Latinas despite being 9% of the population. Latina members constitute over 33% of our membership."} imgURL={'/SHPEtinaImgs/2024Confrence.jpg'}/>
