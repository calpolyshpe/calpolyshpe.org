...
export default function Header() {
    ...
    return (
        <div className="bg-[#001F5B] py-2 px-3 border-b border-white border-opacity-50 relative">
            ...
            <div className="absolute justify-between hidden md:flex w-[550px] right-0 transform -translate-y-1/2 top-1/2" >
                ...
                <Link href="/Members/BecomeAMember">
                    <button className="text-white bg-[#FD652F] rounded lg:text-[14px] text-[11px] md:mr-3 mr-1 px-1 md:py-0.5 py-0.25">
                        Become a Member
                    </button>
                </Link>   
            </div>
