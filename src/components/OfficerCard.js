            ...
            {SHPEboard.map((officer, index) => (
                <div key={index} className=" hidden lg:flex justify-center items-center w-3/4 md:py-12 py-6 border-b border-white border-opacity-15">
                    ...
                    <div className="w-[800px] h-auto flex flex-col justify-center p-3 ml-12">
                        ...
                        <h4 className="text-white text-lg">{officer.email}</h4>
                        <h5 className="text-white text-lg whitespace-pre-wrap">{officer.blurb}</h5>
                    </div>
                </div>
            ))}
            {SHPEboard.map((officer, index) => (
                <div key={index} className="lg:hidden flex flex-col justify-center items-center w-3/4 md:py-12 py-6 border-b border-white border-opacity-15">
                                {/* <img
                                    src={officer.picture}
                                    alt={officer.name}
                                    className="w-72 h-96 object-cover"
                                /> */}
                                <div className="w-full h-auto flex flex-col justify-center p-3 ml-12">
                                    <h1 className="text-white font-bold md:text-xl text-[13px] font-sans mb-3">{officer.role}</h1>
                                    <h2 className="text-white mb-1 md:text-sm text-[9px]">{officer.name}</h2>
                                    <h3 className="text-white mb-1 md:text-sm text-[9px]">{officer.major}</h3>
                                    <h4 className="text-white md:text-sm text-[9px]">{officer.email}</h4>
                                    <h5 className="text-white md:text-sm text-[9px] whitespace-pre-wrap pb-5">{officer.blurb}</h5>
                                </div>
                                <img
                                    src={officer.picture}
                                    alt={officer.name}
